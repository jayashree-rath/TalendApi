...
package local_project.apitest_0_1;
 ...
 * @status
 */
public class Apitest implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Apitest.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Apitest.class);
	...
	private final String jobName = "Apitest";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Apitest.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class RestServiceProviderImpl4TalendJob {
		...
		private final Apitest job;

		public RestServiceProviderImpl4TalendJob(Apitest job) {
			this.job = job;
		}

		private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, Apitest job) {
		...
		public javax.ws.rs.core.Response result(
			...
			request_tRESTRequest_1.put("OPERATION", "result");
			request_tRESTRequest_1.put("PATTERN", "/ping");
	...
	class Thread4RestServiceProviderEndpoint extends Thread {
		...
		public Thread4RestServiceProviderEndpoint(Apitest job, String endpointUrl) {
			this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = Apitest.class.getClassLoader()
					.getResourceAsStream("local_project/apitest_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = Apitest.class.getClassLoader()
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_Apitest = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_Apitest = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_Apitest.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_Apitest.length == 0) {
						commonByteArray_LOCAL_PROJECT_Apitest = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_Apitest = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_Apitest, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_Apitest, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_Apitest) {
	...
	public void tRESTRequest_1_LoopProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				runStat.updateStatAndLog(execStat, enableLogStash, iterateId, 0, 0, "result", "row2");
				...
				try {
					...
					runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, 0, 0, "result");
					...
					if (requestMessage_tRESTRequest_1.containsKey("ERROR")) { // wrong request received
						...
						java.util.Map<String, Object> params_tRESTRequest_1 = (java.util.Map<String, Object>) requestMessage_tRESTRequest_1
								.get("PARAMS");
						if (matchedFlow_tRESTRequest_1.equals("result")) {
...
// Start of branch "result"
					if (result != null) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "result", "tRESTRequest_1_In", "tRESTRequest_1_In", "tRESTRequestIn", "tJavaRow_1",
								"tJavaRow_1", "tJavaRow"
						...
						if (log.isTraceEnabled()) {
							log.trace("result - " + (result == null ? "" : result.toLogString()));
						}
...
//
// lowercase the name
// row2.name = result.name.toLowerCase();
						row2.body = "Ping received";
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row2", "tJavaRow_1", "tJavaRow_1", "tJavaRow", "tRESTResponse_1", "tRESTResponse_1",
								"tRESTResponse"
					...
					if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "result", 2, 0,
				...
				runStat.updateStatAndLog(execStat, enableLogStash, iterateId, 2, 0, "result", "row2");
	...
	public static void main(String[] args) {
		final Apitest ApitestClass = new Apitest();

		int exitCode = ApitestClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Apitest' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'Apitest' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = Apitest.class.getClassLoader()
					.getResourceAsStream("local_project/apitest_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Apitest.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Apitest");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 81228 characters generated by Talend Cloud Real-Time Big Data Platform on the
 * 12 July 2023 13:10:16 BST
 ************************************************************************************************/